...
> This is the original README of [solari-sdk/solari-cookbook](https://github.com/solari-sdk/solari-cookbook),
> kept here because this repo is a fork of it. The nine examples below are unchanged.
> The fork adds one more: [LANPARTY.EXE](examples/lanparty) — see the [main README](README.md).
